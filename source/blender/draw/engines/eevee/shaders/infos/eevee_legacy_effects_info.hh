...
/*    TRACE*/
GPU_SHADER_CREATE_INFO(eevee_legacy_effect_ssgi_trace)
    .additional_info("eevee_legacy_surface_lib_step_raytrace")
    .additional_info("eevee_legacy_common_lib")
    .additional_info("draw_view")
    .additional_info("eevee_legacy_common_utiltex_lib")
    ...
    .additional_info("draw_fullscreen")
    .sampler(0, ImageType::FLOAT_2D, "normalBuffer")
    .sampler(1, ImageType::FLOAT_2D, "ssgiInputBuffer")
    .push_constant(Type::VEC2, "targetSize")
    .push_constant(Type::FLOAT, "randomScale")
    .fragment_out(2, Type::VEC4, "ssgiHitData")
    .fragment_out(3, Type::FLOAT, "ssgiHitDepth")
    .fragment_source("effect_ssgi_trace_frag.glsl")
    .auto_resource_location(true)
    .do_static_compilation(true);
...
/*    RESOLVE*/
GPU_SHADER_CREATE_INFO(eevee_legacy_effect_ssgi_resolve)
    .additional_info("eevee_legacy_surface_lib_step_resolve")
    .additional_info("eevee_legacy_common_lib")
    .additional_info("draw_view")
    .additional_info("eevee_legacy_common_utiltex_lib")
    ...
    .sampler(0, ImageType::FLOAT_2D, "colorBuffer")
    .sampler(1, ImageType::FLOAT_2D, "normalBuffer")
    .sampler(2, ImageType::FLOAT_2D, "ssgiInputBuffer")
    .sampler(3, ImageType::FLOAT_2D, "ssgiHitBuffer")
    .sampler(4, ImageType::FLOAT_2D, "ssgiHitDepth")
    .push_constant(Type::INT, "samplePoolOffset")
    .fragment_out(0, Type::VEC4, "fragColor")
    .fragment_out(4, Type::VEC4, "ssgiFilterInput")
    .fragment_source("effect_ssgi_resolve_frag.glsl")
    .auto_resource_location(true)
    .do_static_compilation(true);

/*   FILTER A */
GPU_SHADER_CREATE_INFO(eevee_legacy_effect_ssgi_filter)
    .additional_info("eevee_legacy_surface_lib_step_resolve")
    .additional_info("eevee_legacy_common_lib")
    .additional_info("draw_view")
    .additional_info("eevee_legacy_common_utiltex_lib")
    ...
    .sampler(1, ImageType::FLOAT_2D, "normalBuffer")
    .sampler(2, ImageType::FLOAT_2D, "ssgiInputBuffer")
    .sampler(3, ImageType::FLOAT_2D, "ssgiFilterInput")
    .push_constant(Type::VEC2, "targetSize")
    .push_constant(Type::INT, "samplePoolOffset") //  uniform vec2 resolveSize;
    .fragment_out(5, Type::VEC4, "ssgiFilterSecInput")
    .fragment_source("effect_ssgi_filter_frag.glsl")
    .auto_resource_location(true)
    .do_static_compilation(true);

/*    FILTER B */
GPU_SHADER_CREATE_INFO(eevee_legacy_effect_ssgi_filter_sec)
    .additional_info("eevee_legacy_surface_lib_step_resolve")
    .additional_info("eevee_legacy_common_lib")
    .additional_info("draw_view")
    .additional_info("eevee_legacy_common_utiltex_lib")
    ...
    .sampler(2, ImageType::FLOAT_2D, "ssgiInputBuffer")
    .sampler(3, ImageType::FLOAT_2D, "ssgiFilterInput")
    .sampler(4, ImageType::FLOAT_2D, "ssgiFilterSecInput")
    .push_constant(Type::VEC2, "targetSize")
    .push_constant(Type::INT, "samplePoolOffset") //  uniform vec2 resolveSize;
    .fragment_out(0, Type::VEC4, "fragColor")
    .fragment_source("effect_ssgi_filter_sec_frag.glsl")
    .auto_resource_location(true)
    .do_static_compilation(true);

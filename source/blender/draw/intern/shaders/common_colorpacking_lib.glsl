...
/* currently unused - no longer channel packing SSR and SSGI input data */
const float c_precision = 4096.0; //4096 (12bit * 2) // 65536
//const float c_precision = 65536.0;
const float c_precisionp1 = c_precision + 1.0;
const float range = 0.5; //Disabling for temporariy banding fix
const float range_inverse = 2;
